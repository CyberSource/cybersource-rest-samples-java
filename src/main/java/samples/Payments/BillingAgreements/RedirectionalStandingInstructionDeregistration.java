...
public class RedirectionalStandingInstructionDeregistration {
	...
	public static PtsV2ModifyBillingAgreementPost201Response run() {
		...
		orderInformationAmountDetails.totalAmount("109.00");
		orderInformationAmountDetails.currency("INR");
		orderInformation.amountDetails(orderInformationAmountDetails);

		Ptsv2billingagreementsOrderInformationBillTo orderInformationBillTo = new Ptsv2billingagreementsOrderInformationBillTo();
		orderInformationBillTo.address1("201S.DivisionSt.");
		orderInformationBillTo.administrativeArea("MI");
		orderInformationBillTo.company("Visa");
		orderInformationBillTo.country("IN");
		orderInformationBillTo.district("BLR");
		orderInformationBillTo.email("test@cybs.com");
		orderInformationBillTo.firstName("Krishna");
		orderInformationBillTo.lastName("CYBS");
		orderInformationBillTo.locality("NPCI");
		orderInformationBillTo.phoneNumber("9999999999");
		orderInformationBillTo.postalCode("560048");
		...
		actionList.add("CANCEL_AGREEMENT");
