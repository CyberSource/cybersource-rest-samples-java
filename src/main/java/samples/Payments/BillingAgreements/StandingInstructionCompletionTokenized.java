...
public class StandingInstructionCompletionTokenized {
	...
	public static PtsV2CreateBillingAgreementPost201Response run() {
		...
		Ptsv2billingagreementsPaymentInformationTokenizedCard paymentInformationTokenizedCard = new Ptsv2billingagreementsPaymentInformationTokenizedCard();
		paymentInformationTokenizedCard.cryptogram("abcdefgh");
		paymentInformationTokenizedCard.expirationMonth("12");
		paymentInformationTokenizedCard.expirationYear("2031");
		paymentInformationTokenizedCard.number("5082794233463");
		paymentInformationTokenizedCard.transactionType("1");
		paymentInformationTokenizedCard.type("061");
