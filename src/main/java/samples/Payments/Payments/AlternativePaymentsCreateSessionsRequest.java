...
public class AlternativePaymentsCreateSessionsRequest {
	...
	public static PtsV2PaymentsPost201Response2 run() {
		...
		CreateSessionReq requestObj = new CreateSessionReq();
		...
		try {
			...
			result = apiInstance.createSessionRequest(requestObj);
