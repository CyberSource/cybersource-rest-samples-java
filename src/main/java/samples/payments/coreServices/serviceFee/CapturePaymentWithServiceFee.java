...
/**
 * This is a sample code to make payment and capture the payment with service fee
 *
 */
public class CapturePaymentWithServiceFee {
	...
	private static CapturePaymentRequest getRequest() {
		...
		// This is a section to set the details about service fee descriptor(It
		// includes the details about service descriptor's name contact and
		// state and ties it to merchant information).
		...
		// This is a section to set service fee descriptor to merchant
		// information
	...
	public static PtsV2PaymentsCapturesPost201Response process() throws Exception {
		...
		/**
		 * This is a section to create payment request and get the trans id and
		 * use the trans id to capture the transaction with service fee
		 */
		try {
			request = getRequest();
