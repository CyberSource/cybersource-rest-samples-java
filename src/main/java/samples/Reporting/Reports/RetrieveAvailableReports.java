...
public class RetrieveAvailableReports {
	...
	public static ReportingV3ReportsGet200Response run() {
		...
		DateTime startTime = new DateTime("2018-10-01T00:00:00Z").withZone(DateTimeZone.forID("GMT"));
		DateTime endTime = new DateTime("2018-10-30T23:59:59Z").withZone(DateTimeZone.forID("GMT"));
