package payments.authorizePayment.digitalPayments.googlePay;
...
public class AuthorizeGooglePayMerchantDecryption {
	...
	public static void main(String args[]) throws Exception {
		new AuthorizeGooglePayMerchantDecryption();
	}

	public AuthorizeGooglePayMerchantDecryption() throws Exception {
		process();
	}
