package payments.authorizePayment.avsNonUsSupportedCardTypes;
...
public class MaestroUKDomestic {
	...
	private CreatePaymentRequest getRequest() {
		...
		consumerAuthenticationInformation.cavv("EHuWW9PiBkWvqE5juRwDzAUFBAk=");//getting changed
	...
	public static void main(String args[]) throws Exception {
		new MaestroUKDomestic();
	}

	public MaestroUKDomestic() throws Exception {
		process();
	}
